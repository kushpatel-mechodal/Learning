                ...
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <div class="toast-container position-fixed top-0 end-0 p-3">
                            ...
                            <div class="toast fade border-0 shadow rounded-3 " id="registerToast">
                        ...
                        <form id="registerForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control mb-3" name="confirm-password" id="confirm-password" placeholder="Enter your Confirm password" required>
                            </div>
                            ...
                            <div class="text-center mt-3">
                                Already have register? <a href="login.php">Login</a>
                            </div>
                        </form>
                    </div>
                </div>
